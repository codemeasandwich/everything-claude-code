...
> **@affaanmustafa (cogsec) · Sep 16, 2025**
> 
...
![Example of what feedback you get in Claude Code, while running a PostToolUse hook](https://pbs.twimg.com/media/G-1Gwvab0AM7Xr9?format=png&name=small)
...
1. **Single [CLAUDE.md](//CLAUDE.md)** - Everything in one file (user or project level)
...
![Example of the supabase mcp listing the tables within the public schema](https://pbs.twimg.com/media/G-1KHqfawAA-PPK?format=jpg&name=medium)
...
![using /plugins to navigate to MCPs to see which ones are currently installed and their status](https://pbs.twimg.com/media/G-1K2ZJawAAQnV3?format=jpg&name=medium)
...
![displaying the newly installed Mixedbread-Grep marketplace](https://pbs.twimg.com/media/G-1Loo1bYAAI_tz?format=jpg&name=medium)
...
![Zed Editor with custom commands dropdown using CMD+Shift+R. Following mode shown as the bullseye in the bottom right.](https://pbs.twimg.com/media/G-1Cy8gbAAA2fE-?format=jpg&name=medium)
...
![from the docs directly at https://code.claude.com/docs/en/vs-code](https://pbs.twimg.com/media/G-1b3F_aMAApve3?format=jpg&name=medium)
...
![example statusline in my Mac root directory](https://pbs.twimg.com/media/G-1iYlHaEAAbS0C?format=jpg&name=medium)
